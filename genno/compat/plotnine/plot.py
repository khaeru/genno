...
class Plot(ABC):
    ...
    def save(self, config: Mapping, *args: Any, **kwargs: Any) -> Path | None:
    ...
    @classmethod
    def make_task(cls, *inputs: "KeyLike") -> tuple:
    ...
    @classmethod
    def add_tasks(
        cls, c: Computer, key: KeyLike, *inputs: Any, strict: bool = False
    ) -> KeyLike:
    ...
    @abstractmethod
    def generate(self, *args: Any, **kwargs: Any) -> p9.ggplot:
